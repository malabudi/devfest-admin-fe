                ...
                <div className="modal">
                    <div className="modal-content">
                        ...
                        <div className="modal-buttons">
                            <button className="text-purple-600 bg-blue-200 hover:text-white hover:bg-purple-800 font-bold px-4 py-2 rounded" onClick={confirmDelete}>Confirm</button>
                            <button className='text-red-500 hover:bg-red-700 hover:text-white bg-red-100 font-bold px-4 py-2 rounded' onClick={() => setShowModal(false)}>Cancel</button>
                        </div>
                    </div>
                    <style jsx>{`
        .modal {
